...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sample_generator_v1_0_M_AXIS is
  ...
  signal \afterResetCycleCounterR[7]_i_1_n_0\ : STD_LOGIC;
...
\M_AXIS_TLAST_carry_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\M_AXIS_TLAST_carry_i_1__1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\M_AXIS_TLAST_carry_i_2__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\M_AXIS_TLAST_carry_i_2__1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
M_AXIS_TLAST_carry_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88800001"
    )
        port map (
...
\M_AXIS_TLAST_carry_i_3__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\M_AXIS_TLAST_carry_i_4__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\afterResetCycleCounterR[7]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
        ...
        port map (
      I0 => m_axis_aresetn,
      O => \afterResetCycleCounterR[7]_i_1_n_0\
    );
...
\afterResetCycleCounterR_reg[0]\: unisim.vcomponents.FDRE
     port map (
      ...
      R => \afterResetCycleCounterR[7]_i_1_n_0\
    );
